...
public class Constants {
	...
	public static final String FILTER_BY_CREATION = "NEWER";
	public static final String FILTER_BY_POPOLARITY = "FAMOUS";

	public static final int PAGINATION_ELEMENTS_IN_PAGE = 10;
