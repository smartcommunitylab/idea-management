...
public class IdeaLocalServiceUtil {
    ...
    */
    ...
    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByCat(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByCat(catId, begin, end);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByRating()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByRating();
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByRating(
        int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByRating(begin, end);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByRating(
        long catId) throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByRating(catId);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByRating(
        long catId, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByRating(catId, begin, end);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByRating(
        long catId, long[] tagIds)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByRating(catId, tagIds);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByRating(
        long catId, long[] tagIds, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByRating(catId, tagIds, begin, end);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByCall(
        long callId, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByCall(callId, begin, end);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByCall(
        long callId, long[] tagIds, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByCall(callId, tagIds, begin, end);
    }
    ...
    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByCallAndRating(
        ...
        return getService().getIdeasByCallAndRating(callId);
    }
    ...
    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> getIdeasByCallAndRating(
        long callId, long[] tagIds, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getIdeasByCallAndRating(callId, tagIds, begin, end);
    }
    ...
    public static java.util.List<com.liferay.portlet.asset.model.AssetEntry> getCategoryObjects(
        long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getCategoryObjects(groupId);
    }

    public static java.util.Map<java.lang.String, java.lang.String> getCategoryColors(
        long groupId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> searchByCallAndCategoryAndTags(
        long categoryId, long callId, long[] tagIds, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .searchByCallAndCategoryAndTags(categoryId, callId, tagIds,
            begin, end);
    }

    public static java.util.List<it.smartcommunitylab.platform.idea.model.Idea> searchPopularByCallAndCategoryAndTags(
        long categoryId, long callId, long[] tagIds, int begin, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
