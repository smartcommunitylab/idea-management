...
/**
 * Provides the local service interface for Call. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author mirko perillo
 * @see CallLocalServiceUtil
...
public interface CallLocalService extends BaseLocalService, InvokableLocalService,
    PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CallLocalServiceUtil} to access the call local service. Add custom service methods to {@link it.smartcommunitylab.platform.idea.service.impl.CallLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
