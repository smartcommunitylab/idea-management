...
public class IdeaModelImpl extends BaseModelImpl<Idea> implements IdeaModel {
    ...
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "deadlineConstraints", Types.CLOB },
    ...
    public static final String TABLE_SQL_CREATE = "create table IM_Idea (uuid_ VARCHAR(75) null,ideaId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,title VARCHAR(255) null,longDesc TEXT null,shortDesc VARCHAR(75) null,userGroupId LONG,callId LONG,state_ VARCHAR(75) null,stateJudgement TEXT null,deadlineConstraints TEXT null,discussionLimit INTEGER,status INTEGER,statusByUserId LONG,statusByUserName VARCHAR(75) null,categoryIds VARCHAR(75) null)";
    ...
    public Object clone() {
        ...
        ideaImpl.setCategoryIds(getCategoryIds());
    ...
    public CacheModel<Idea> toCacheModel() {
        ...
        ideaCacheModel.categoryIds = getCategoryIds();

        String categoryIds = ideaCacheModel.categoryIds;

        if ((categoryIds != null) && (categoryIds.length() == 0)) {
            ideaCacheModel.categoryIds = null;
        }
