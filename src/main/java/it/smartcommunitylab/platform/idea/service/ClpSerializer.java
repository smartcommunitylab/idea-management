...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "idea-management-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "idea-management";
            }
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals(
                    "it.smartcommunitylab.platform.idea.IdeaLongDescException")) {
            return new it.smartcommunitylab.platform.idea.IdeaLongDescException();
        }

        if (className.equals(
                    "it.smartcommunitylab.platform.idea.IdeaTitleException")) {
            return new it.smartcommunitylab.platform.idea.IdeaTitleException();
        }
