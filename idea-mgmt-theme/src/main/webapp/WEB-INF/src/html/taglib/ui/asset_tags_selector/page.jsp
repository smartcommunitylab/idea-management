...
<div class="lfr-tags-selector-content" id="<%= namespace + id %>assetTagsSelector">
	...
	<input placeholder="<liferay-ui:message key="add-tags-input" />" class="lfr-tag-selector-input" id="<%= id %>assetTagNames" maxlength="75" size="25" title="<liferay-ui:message key="add-tags" />" type="text" />
</div>
