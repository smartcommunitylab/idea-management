...
if (Validator.isNull(url) && (userDisplay != null)) {
	...
	groupId = userDisplay.getGroupId();
}
%>
<liferay-portlet:renderURL portletName="userprofile_WAR_ideamanagement" var="loginPortletURL" windowState="maximized">
...
<div class="taglib-user-display display-style-<%= displayStyle %>">
	...
	<aui:a href="<%= loginPortletURL.toString() %>">
